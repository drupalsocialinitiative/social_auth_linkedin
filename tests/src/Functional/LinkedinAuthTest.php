...
class LinkedinAuthTest extends BrowserTestBase {
   ...
   * @var array
   */
  public static $modules = array('social_auth', 'social_auth_linkedin');
  ...
  public function testConfigPage(){
    ...
    $admin_user = $this->drupalCreateUser(array('administer social api authentication'));
  ...
  public function testAuthCallback(){
    ...
    $this->drupalGet('/user/login/linkedin');
    $assert->statusCodeEquals(301);
